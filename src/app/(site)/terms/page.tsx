export default function TermsPage() {
  return (
    <div className="text-justify md:px-40 py-20">
      ...
      <h4 className="md:pt-24 pt-12 font-bold">LEGAL TERMS OF USE</h4>
      <p className="pt-4">
        These Terms of Use constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity (“you”) and aeradron,
        doing business as revit (&quot;revit&quot;, “we”, “us”, or “our”),
        concerning your access to and use of the revit as well as any other
        ...
        &quot;App&quot;). You agree that by accessing the App, you have read,
        ...
        of the App after the date such revised Terms of Use are posted. The
        information provided on the App is not intended for distribution to or
        ...
        local laws are applicable. All users who are minors in the jurisdiction
        ...
        to use the App. If you are a minor, you must have your parent or
        guardian read and agree to these Terms of Use prior to you using the
        App.
      </p>
      <h5 className="pt-8 font-bold">INTELLECTUAL PROPERTY RIGHTS</h5>
      <p className="pt-4">
        ...
        and the Marks are provided on the App “AS IS” for your information and
        personal use only. Except as expressly provided in these Terms of Use,
        no part of the App and no Content or Marks may be copied, reproduced,
        aggregated, republished, uploaded, posted, publicly displayed, encoded,
        translated, transmitted, distributed, sold, licensed, or otherwise
        exploited for any commercial purpose whatsoever, without our express
        prior written permission. Provided that you are eligible to use the App,
        you are granted a limited license to access and use the App and to
      ...
      <h5 className="pt-8 font-bold">USER REPRESENTATIONS</h5>
      <p className="pt-4">
        ...
        you have received parental permission to use the App; (5) you will not
        access the App through automated or non-human means, whether through a
        bot, script, or otherwise; (6) you will not use the App for any illegal
        or unauthorized purpose; and (7) your use of the App will not violate
      ...
      <h5 className="pt-8 font-bold">USER REGISTRATION</h5>
      <p className="pt-4">
        You may be required to register with the App. You agree to keep your
        password confidential and will be responsible for all use of your
        account and password. We reserve the right to remove, reclaim, or change
        a username or profile image you select if we determine, in our sole
        discretion, that such username or profile image is inappropriate,
        obscene, or otherwise objectionable.
      </p>
      <h5 className="pt-8 font-bold">PROHIBITED ACTIVITIES</h5>
      <p className="pt-4">
      ...
      <p className="pt-4">As a user of the App, you agree not to:</p>
      <ol className="list-disc pl-10 py-2">
        <li>
        ...
        <li>
          ...
          the App and/or the Content for any revenue-generating endeavor or
          commercial enterprise.
        </li>
      </ol>
      <h5 className="pt-8 font-bold">USER GENERATED CONTRIBUTIONS</h5>
      <p className="pt-4">
        The App may invite you to chat, contribute to, or participate in blogs,
        ...
        or on the App, including but not limited to text, writings, video,
      ...
      <ol className="list-disc py-2 pl-10">
        <li>
        ...
        <li>
          ...
          us, the App, and other users of the App to use your Contributions in
        ...
        <li>
          ...
          or regulation. Any use of the App in violation of the foregoing
          violates these Terms of Use and may result in, among other things,
          termination or suspension of your rights to use the App.
        </li>
      </ol>
      <h5 className="pt-8 font-bold">CONTRIBUTION LICENSE</h5>
      <p className="pt-4">
        By posting your Contributions to any part of the App, you automatically
        ...
        the App. You are solely responsible for your Contributions to the App
        ...
        locations on the App; and (3) to pre-screen or delete any Contributions
        at any time and for any reason, without notice. We have no obligation to
        monitor your Contributions.
      </p>
      <h5 className="pt-8 font-bold">MOBILE APPLICATION LICENSE</h5>
      <p className="pt-4">
        ...
        (each an “App Distributor”) to access the App: (1) the license granted
        ...
        subject to the Indian government embargo, or that has been designated by
        the Indian government as a “terrorist supporting” country and (ii) you
      ...
      <h5 className="pt-8 font-bold">SUBMISSIONS</h5>
      <p className="pt-4">
      ...
      <h5 className="pt-8 font-bold">APP MANAGEMENT</h5>
      <p className="pt-4">
        We reserve the right, but not the obligation, to: (1) monitor the App
        ...
        App in a manner designed to protect our rights and property and to
        facilitate the proper functioning of the App.
      </p>
      <h5 className="pt-8 font-bold">PRIVACY POLICY</h5>
      <p className="pt-4">
        We care about data privacy and security. By using the App, you agree to
        be bound by our Privacy Policy posted on the App, which is incorporated
        into these Terms of Use. Please be advised the App is hosted in India.
        ...
        continued use of the App, you are transferring your data to India, and
        you agree to have your data transferred to and processed in India.
      </p>
      <h5 className="pt-8 font-bold">COPYRIGHT INFRINGEMENTS</h5>
      <p className="pt-4">
        ...
        report feature or help & support feature or contact information provided
        ...
        linked to by the App infringes your copyright, you should consider first
        contacting an attorney.
      </p>
      <h5 className="pt-8 font-bold">TERM AND TERMINATION</h5>
      <p className="pt-4">
        These Terms of Use shall remain in full force and effect while you use
        the App. WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS OF USE, WE
      ...
      <h5 className="pt-8 font-bold">MODIFICATIONS AND INTERRUPTIONS</h5>
      <p className="pt-4">
        We reserve the right to change, modify, or remove the contents of the
        App at any time or for any reason at our sole discretion without notice.
        However, we have no obligation to update any information on our App. We
        ...
        of the App. Nothing in these Terms of Use will be construed to obligate
        us to maintain and support the App or to supply any corrections,
        updates, or releases in connection therewith. GOVERNING LAW These Terms
        shall be governed by and defined following the laws of India. aeradron
        and yourself irrevocably consent that the courts of India shall have
        exclusive jurisdiction to resolve any dispute which may arise in
        connection with these terms.
      </p>
      <h5 className="pt-8 font-bold">DISPUTE RESOLUTION</h5>
      <p className="pt-4">
        ...
        you or us (individually, a “Party” and collectively, the “Parties”), the
        Parties agree to first attempt to negotiate any Dispute (except those
        Disputes expressly provided below) informally for at least ten (10) days
        ...
        BENGALURU, India. The language of the proceedings shall be English. The
        governing law of the contract shall be the substantive law of India.
        Restrictions The Parties agree that any arbitration shall be limited to
      ...
      <h5 className="pt-8 font-bold">CORRECTIONS</h5>
      <p className="pt-4">
      ...
      <h5 className="pt-8 font-bold">DISCLAIMER</h5>
      <p className="pt-4">
        ...
        DAMAGES ARISING FROM YOUR USE OF THE APP, EVEN IF WE HAVE BEEN ADVISED
        OF THE POSSIBILITY OF SUCH DAMAGES. NOT WITHSTANDING ANYTHING TO THE
        ...
        TO 100 INR. CERTAIN INDIAN STATE LAWS AND INTERNATIONAL LAWS DO NOT
      ...
      <h5 className="pt-8 font-bold">INDEMNIFICATION</h5>
      <p className="pt-4">
        ...
        Contributions; (2) use of the App; (3) breach of these Terms of Use; (4)
        ...
        connected via the App. Not withstanding the foregoing, we reserve the
      ...
      <h5 className="pt-8 font-bold">USER DATA</h5>
      <p className="pt-4">
        ...
        to your use of the App. Although we perform regular routine backups of
        ...
        from any such loss or corruption of such data. ELECTRONIC
        COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES Visiting the App, sending
        ...
        App, satisfy any legal requirement that such communication be in
        writing. YOU HEREBY AGREE TO THE USE OF ELECTRONIC SIGNATURES,
        CONTRACTS, ORDERS, AND OTHER RECORDS, AND TO ELECTRONIC DELIVERY OF
        NOTICES, POLICIES, AND RECORDS OF TRANSACTIONS INITIATED OR COMPLETED BY
        US OR VIA THE App. You hereby waive any rights or requirements under any
        statutes, regulations, rules, ordinances, or other laws in any
        jurisdiction which require an original signature or delivery or
        retention of non-electronic records, or to payments or the granting of
        credits by any means other than electronic means.
      </p>
      <h5 className="pt-8 font-bold">MISCELLANEOUS</h5>
      <p className="pt-4">
        These Terms of Use and any policies or operating rules posted by us on
        the App or in respect to the App constitute the entire agreement and
        ...
        us as a result of these Terms of Use or use of the App. You agree that
      ...
      <h5 className="pt-8 font-bold">CONTACT US</h5>
      <p className="pt-4">
        In order to resolve a complaint regarding the App or to receive further
        information regarding use of the App, please mail us at
        aeradron@gmail.com
      </p>
      <br />
      <p>
        <b>TERMS OF USE</b> <br /> Last updated March 01, 2025
      </p>
    </div>
  );
}
