  ...
  return (
    <div className="text-justify md:px-40 py-20">
      ...
      <p className="md:pt-24 pt-12">
        ...
        business as revit (“revit”, “we”, “us”, or “our”). We are committed to
        ...
        at support@aeradron.com. When you visit our website (the
        &quot;Website&quot;), use our mobile application, as the case may be
        (the &quot;App&quot;) and more generally, use any of our services (the
        &quot;Services&quot;, which include the Website and App), we appreciate
        ...
        discontinue use of our Services immediately. This privacy policy applies
        to all information collected through our Services (which, as described
        above, includes our Website and App), as well as any related services,
        sales, marketing or events. App&apos;s use and transfer to any other app
      ...
      <p>
        Please read this privacy policy carefully as it will help you understand
      ...
      <div className="pt-16" />
      <h4 className="font-bold">1. WHAT INFORMATION DO WE COLLECT?</h4>
      <p className="pt-4">
      ...
      <p>
        ...
        in activities on the Services (such as by Signing Up to App) or
        otherwise when you contact us. The personal information that we collect
        ...
        information we collect may include the following: Personal Information
        Provided by You. We collect names; phone numbers; mailing addresses;
        email addresses; profession; job titles; usernames; passwords;
        authentication data; date of birth and other similar information.
        Payment Data, we do not store any payment related data we only store the
        Transaction information for future references. All our payments are
        handled by Razorpay. All personal information that you provide to us
        must be true, complete and accurate, and you must notify us of any
        changes to such personal information. Information collected through our
        App In Short: We collect information regarding your push notifications,
        when you use our App. We may request to send you push notifications
        regarding your account or certain features of the App. The information
        is primarily needed to maintain the operation of our App.
      </p>

      <div className="pt-16" />
      <h4 className="font-bold">2. HOW DO WE USE YOUR INFORMATION?</h4>
      <p className="pt-4">
      ...
      <p>
        ...
        below. We use the information we collect or receive: To facilitate
        account creation and logon process. To post testimonials. We post
        ...
        name and the consent of the testimonial. If you wish to update, or
        delete your testimonial, please contact us at support@aeradron.com and
        ...
        managing your account and keeping it in working order. To send
        administrative information to you. We may use your personal information
        to send you product, service and new feature information and/or
        information about changes to our terms, conditions, and policies. To
        protect our Services. We may use your information as part of our efforts
        to keep our Services safe and secure (for example, for fraud monitoring
        ...
        in connection with our contract. To respond to legal requests and
        prevent harm. If we receive a subpoena or other legal request, we may
        need to inspect the data we hold to determine how to respond. To send
        you marketing and promotional communications. We and/or our third-party
        ...
        otherwise contacting us, we will collect personal information from you.
      ...
      <p>
        ...
        and pixels) to access or store information. For specific information
        about how we use such technologies and how you can refuse certain
        cookies you can contact us at support@aeradron.com.
      </p>

      <div className="pt-16" />
      <h4 className="font-bold">5. HOW LONG DO WE KEEP YOUR INFORMATION?</h4>
      <p className="pt-4">
      ...
      <div className="pt-16" />
      <h4 className="font-bold">6. WHAT ARE YOUR PRIVACY RIGHTS?</h4>
      <p className="pt-4">
      ...
      <p>
        ...
        email us at support@aeradron.com. Account Information: If you would at
        ...
        active databases. However, we may retain some information in our files
      ...
      <div className="pt-16" />
      <h4 className="font-bold">7. DO WE MAKE UPDATES TO THIS POLICY?</h4>
      <p className="pt-4">
      ...
      <p>
        ...
        posting a policy of such changes or by directly sending you a
      ...
      <p className="pt-4">
        ...
        review, update, or delete your personal information, please mail us at
        support@aeradron.com. We will respond to your request within 30 days.
      </p>
      <p className="pt-24">
        <b>PRIVACY POLICY</b> <br /> Last updated March 01, 2025
      </p>
    </div>
  );
}
