...
import { BusinessForm, ForumForm } from "@/src/types/form";
...
import BusinessCreateFirst from "./Steps/First";
import BusinessCreateSecond from "./Steps/Second";
import { BusinessRequest } from "@/src/types/business";
import { saveBusinessAction } from "@/src/app/(site)/(home)/business/action";

export default function BusinessCreateModal(props: ModalProps) {
  ...
  const businessFormSteps = () => {
    switch (currentStep) {
      case 0:
        return <BusinessCreateFirst form={form} setForm={setForm} />;

      case 1:
        return <BusinessCreateSecond form={form} setForm={setForm} />;
    ...
    >
      <ModalContent>
        ...
        <ModalBody className="min-h-[50vh] py-10 px-10 w-full">
          ...
          <Form id="createBusiness" onSubmit={onSubmit}>
            {businessFormSteps()}
          </Form>
        </ModalBody>
